...
6. For any pip installation related errors, check the section below
...
# Common Errors
If you're getting a bad authentication failed error related to MongoDB Atlas, it is likely that the .env file is configured
incorrectly. Go to "Database & Network Access" on the left hand side of the MongoDB webpage. Double check your username and 
passsword and ensure that it matches the information contained in your .env file. The angle brackets (<>) should be omitted
from the MongoDB URI.
